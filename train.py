...
import numpy as np
from utils.utils import get_confusion_matrix, create_model
...
# Verify the number of classes we have given manually matches with the classes in the database
...
model.fit(
        ...
        callbacks=[model_checkpoint_callback, tensorboard_callback, lr_callback, cm_callback]
        )
